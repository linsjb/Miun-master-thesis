...
In this cleaning step the \acrshort{rssi} and minor values is being stored in a \acrshort{json} formatted array, at the same format as \Cref{listing:beaconFingerprint} above.}
