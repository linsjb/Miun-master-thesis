...
\mt{In the iBeacon data that comes from the application the data it not formatted in the right way, and looks like the example presented in \Cref{listing:beaconFingerprint}.
This data is cleaned and formatted as presented in \Cref{listing:deviceRawBeaconData}.}
