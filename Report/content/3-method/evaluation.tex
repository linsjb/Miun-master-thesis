...
\mt{The accuracy was being calculated for one mapped fingerprint per point and four mapped fingerprints per point. The results from the measurements could then be compared with each other for each group, which is being presented in \cref{sec:resultPos}.}
