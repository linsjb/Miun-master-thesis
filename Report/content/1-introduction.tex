...
\mt{How, as accurate as possible, locate handheld devices in indoor environments without GPS signals?}
...
\begin{enumerate}
	...
	\item \label{goal:systemEvaluation}
		\mt{Evaluate the positioning accuracy of the implemented \acrshort{ips} by physical testing}
\end{enumerate}
...
In \Cref{method} the methods are being described in detail.
...
Lastly in \Cref{conclusion} the conclusion of the thesis is being discussed as a project summary and how well the goals were fulfilled.
