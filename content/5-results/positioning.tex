...
\fig{Measurement result with one fingerprint per point for blue group}{bluePointResult1p}{1}{results/pointsBlue1p}

\fig{Measurement result with one fingerprint per point for yellow group}{yellowPointResult1p}{1}{results/pointsYellow1p}

\fig{Measurement result with one fingerprint per point for brown group}{brownPointResult1p}{1}{results/pointsBrown1p}
...
\fig{Measurement result with four fingerprints per point for blue group}{bluePointResult4p}{1}{results/pointsBlue4p}

\fig{Measurement result with four fingerprints per point for yellow group}{yellowPointResult4p}{1}{results/pointsYellow4p}

\fig{Measurement result with four fingerprints per point for brown group}{brownPointResult4p}{1}{results/pointsBrown4p}
