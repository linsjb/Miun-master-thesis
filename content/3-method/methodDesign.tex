...
The performed literature review showed that the papers... \cite{} which all implemented a \acrlong{ips} has no clear method but was all following the same structure.
...
To better suite some changes was made and the final method framework used in this thesis can be seen in \cref{fig:methodOverview}.
